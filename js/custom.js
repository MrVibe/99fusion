...
jQuery(document).ready(function($) { 
 ...
 var topMenuHeight = 0;//topMenu.outerHeight()+15
     // All list items
 var menuItems = topMenu.find("a:not(.external_link)"),
...
jQuery(document).ready(function($){  
  ...
  var map;
           ...
           function initialize() {
              ...
              var point = new google.maps.LatLng(28.5955434,77.3172169);
              var centrePoint = new google.maps.LatLng(28.5955434,77.3172169 );
        ...
        map.setMapTypeId('tehgrayz');
          ...
          twitterFetcher.fetch('452786622203850752', 'tweet', 1, true);
